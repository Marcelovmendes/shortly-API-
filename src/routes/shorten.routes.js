...
import { ValidategetUser, openUrl, validateDeleteShorten, validateShorten } from "../middlewares/authValidate.middleware.js";
...
shortenRouter.get("/urls/open/:shortUrl",openUrl,redirectUrl)
